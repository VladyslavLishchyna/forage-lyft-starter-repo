...
class BatteriesFactory:
    def __init__(self, batteries_options: BatteriesOptions):
        ...
        for specific_battery_type in BatteryType:
            period_between_services = batteries_options.TIME_BETWEEN_SERVICES[specific_battery_type]
            self.batteries_service_needed_checkers[specific_battery_type] = BatteriesServiceNeededChecker(
                period_between_services)
