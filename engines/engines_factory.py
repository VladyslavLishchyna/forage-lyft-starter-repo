...
class EnginesFactory():
    ...
    def create(self, current_mileage: int, last_service_mileage: int, warning_light_on: bool,
               last_service_date: datetime, engine_type: EngineType,
               engine_service_needed_checking_type: EngineServiceNeededCheckingType):

        engine_service_needed_checker = self.__resolve_engine_service_needed_checker(engine_type,
                                                                                     engine_service_needed_checking_type)
        return Engine(current_mileage, last_service_mileage, warning_light_on, last_service_date,
                      engine_service_needed_checker)

    def __resolve_engine_service_needed_checker(self, engine_type: EngineType,
                                                engine_service_needed_checking_type: EngineServiceNeededCheckingType):
